                ...
                <form onSubmit={handleSubmit(AddTouristsSpot)} className="space-y-6  ">
                    <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1 text-sm">
                            ...
                            <input type="email" {...register("email")} placeholder="User Email" className="w-full px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" />
                        </div>
